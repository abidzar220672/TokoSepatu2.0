...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root {
      --bg:#f0f2f5; --sidebar:#0f172a; --sidebar-hover:#1e293b;
      --sidebar-active:#1d4ed8; --accent:#1d4ed8; --accent-h:#1e40af;
      --white:#ffffff; --card-br:14px; --text:#1e293b; --muted:#64748b;
      --border:#e2e8f0; --sidebar-w:240px; --topbar-h:64px;
    }
    ...
    .sidebar-brand { padding:22px 24px 18px; border-bottom:1px solid rgba(255,255,255,.07); }
    .sidebar-brand h1 { color:#fff; font-size:1.3rem; font-weight:700; letter-spacing:2px; }
    .sidebar-brand p  { color:#94a3b8; font-size:11px; margin-top:2px; }
    .sidebar-section  { padding:18px 14px 6px; }
    .sidebar-section-label { font-size:10px; text-transform:uppercase; letter-spacing:1px; color:#475569; font-weight:600; padding:0 10px; margin-bottom:6px; }
    .nav-item {
    ...
    .btn-store {
      ...
      background:var(--accent); color:#fff; text-decoration:none; transition:background .15s;
    }
    ...
    .stat-card {
      ...
      display:flex; align-items:center; gap:16px; transition:box-shadow .2s;
    }
    ...
    /* TABLE CARD */
    .table-card { background:var(--white); border-radius:var(--card-br); border:1px solid var(--border); overflow:hidden; }
    .table-card-header { padding:18px 22px; display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid var(--border); }
    ...
    .data-table tbody td { padding:13px 18px; font-size:13.5px; border-bottom:1px solid #f1f5f9; vertical-align:middle; }
    ...
    .kat-tag { background:#f1f5f9; color:#475569; padding:3px 10px; border-radius:6px; font-size:12px; }
...
<div class="topbar">
  ...
  <div class="topbar-right">
    <a href="<?= $base_url ?>" class="btn-store">
      <i class="fa-solid fa-store"></i> Lihat Toko
    </a>
  </div>
</div>
  ...
  <div class="content">
    ...
    <div class="stat-grid">
      <div class="stat-card">
        ...
        <div><div class="stat-label">Total Produk</div><div class="stat-value"><?= $total ?></div></div>
      </div>
      <div class="stat-card">
        <div class="stat-icon orange"><i class="fa-solid fa-mars"></i></div>
        <div><div class="stat-label">Men</div><div class="stat-value"><?= $cnt_men ?></div></div>
      </div>
      <div class="stat-card">
        <div class="stat-icon pink"><i class="fa-solid fa-venus"></i></div>
        <div><div class="stat-label">Women</div><div class="stat-value"><?= $cnt_women ?></div></div>
      </div>
      <div class="stat-card">
        <div class="stat-icon green"><i class="fa-solid fa-child"></i></div>
        <div><div class="stat-label">Kids</div><div class="stat-value"><?= $cnt_kids ?></div></div>
      </div>
    </div>
    ...
    <div class="table-card">
      ...
      <?php if ($total === 0): ?>
        <div class="empty-state">
          ...
          <a href="admin-page/form.php" class="btn-add" style="display:inline-flex;margin-top:12px">
