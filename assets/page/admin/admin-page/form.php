<?php
// 1. Tampilkan error untuk debugging di hosting
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

// 2. Gunakan path relatif yang benar (naik 3 tingkat ke assets lalu ke config)
...
// 3. Ambil data untuk pilihan (dropdown)
